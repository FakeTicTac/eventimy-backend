...
namespace WebApp.Controllers
{
    public class MediaFileTypeController : Controller
    {
        ...
        // GET: MediaFileType/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: MediaFileType/Create
